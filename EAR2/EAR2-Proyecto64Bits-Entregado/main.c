...
void probarPrimitivasUno(FILE *fpPant)
{
    ...
    cantRepe = eliminarYMostrarRepetidos_MIO(&lista, fpPant,compararFinal_MIO,mostrarFinal_MIO);
    ...
    cantUnic = eliminarYMostrarUnicos_MIO(&lista, fpPant,compararFinal_MIO, mostrarFinal_MIO);
